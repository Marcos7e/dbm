  ...
  <div class="col-xl-4 col-sm-12 col-12">
    <div class="card" style="width: 20rem;">
      <div class="card-body">
        ...
        <a href="<?php echo e(url('/registrarEstudiantes')); ?>" class="card-link">&raquo;Ir a Registro de Estudiantes.</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-xl-4 col-sm-12 col-12">
    <div class="card" style="width: 20rem;">
      <div class="card-body">
        ...
        <a href="<?php echo e(url('/registrarMatricula')); ?>" class="card-link">&raquo;Ir a Registro de Matriculas.</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-xl-4 col-sm-12 col-12">
    <div class="card" style="width: 20rem;">
      <div class="card-body">
        ...
        <a href="<?php echo e(url('/registrarMaterias')); ?>" class="card-link">&raquo;Ir a Registro masivo de Materias.</a>
      </div>
    </div>
  </div>
